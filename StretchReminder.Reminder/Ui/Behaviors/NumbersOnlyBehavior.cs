...
{
    public static class NumbersOnlyBehavior
    {
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached("IsEnabled", typeof(bool), typeof(NumbersOnlyBehavior), new UIPropertyMetadata(false, OnValueChanged));
